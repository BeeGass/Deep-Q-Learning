...
class DQN():
    def __init__(self):
        ...
        loadedData = torch.load('breakout-dqnWeights.pt')
...
#             loss = -100000000000
            ...
            if (e + 1) % 10 == 0:
                ...
                self.save_weights(self.agent.replay_buffer_list, self.epsilon, self.agent.model.state_dict(), self.scoreEachEp)
